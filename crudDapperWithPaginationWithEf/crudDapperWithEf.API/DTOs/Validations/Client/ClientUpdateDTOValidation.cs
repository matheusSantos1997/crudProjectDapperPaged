...
{
    public class ClientUpdateDTOValidation : AbstractValidator<UpdateClientDTO>
    {
        public ClientUpdateDTOValidation()
        {
        ...
        RuleFor(x => x.Products)
            ...
            .ForEach(produto => produto.SetValidator(new ProductUpdateDTOValidation())); // Valida cada item na lista
        }
    }
}